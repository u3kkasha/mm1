...
namespace Singleton
{
   ...
   */
    ...
    enum class Average_kind {
       ...
       public:
       auto static calculate_server_utilisation(){return compute_average(Average_kind::time,Information_kind::service_time);}
       auto static calculate_average_number_of_people_inside_system(){return compute_average(Average_kind::time,Information_kind::sojourn_time);}
       auto static calculate_average_queue_length(){return compute_average(Average_kind::time,Information_kind::waiting_time);}
       auto static calculate_average_waiting_time(){return compute_average(Average_kind::job,Information_kind::waiting_time);}
       auto static calculate_average_service_time(){return compute_average(Average_kind::job,Information_kind::service_time);}
       auto static calculate_average_sojourn_time(){return compute_average(Average_kind::job,Information_kind::sojourn_time);}
    }; //end of class
}//end of namespace
