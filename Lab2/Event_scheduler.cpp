...
namespace Singleton
{
        void Event_scheduler::schedule_next_arrival() {
            ...
            */
            ...
            auto mean_inter_arrival_time = settings.get_mean_inter_arrival_time();
            int trigger_time = Timing_unit::get_current_time()+Random_variate_generator::get_exponential(mean_inter_arrival_time);
            Event_list::add_event(Event_kind::arrival, trigger_time);
        }
        void Event_scheduler::schedule_next_departure() {
            auto settings =
             /*
            ...
            */
            ...
            auto mean_service_time = settings.get_mean_service_time();
            int trigger_time = Timing_unit::get_current_time()+Random_variate_generator::get_exponential(mean_service_time);
            Event_list::add_event(Event_kind:: departure, trigger_time);
